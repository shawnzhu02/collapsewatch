...
real_path = 'ieee-init.jsonl'
synthetic_path = 'ieee-chatgpt-generation.jsonl'
...
real_abstracts = [entry["abstract"] for entry in real_data]
synth_abstracts = [entry["abstract"] for entry in synthetic_data]
